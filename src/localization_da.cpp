...
namespace Localization
{
    const std::unordered_map<std::string, const char*> GetDanishTranslations()
    {
        static const std::unordered_map<std::string, const char*> translations = {
            ...
            {"icon_cache_unlimited", "Ubegrænset (∞)"},
            {"icon_cache_unlimited_tooltip", "Ingen grænse for størrelsen af ikon-cache"},
            ...
            {"mini_window_click_through", "Vindue click through (no longer movable or resizable)"},
            ...
            {"mini_window_locked", "Lås Mini Vindue (no longer movable or resizable)"},
            ...
            {"api_discrepancy_active", "API-uoverensstemmelse aktiv"},
            {"magnetite_reset_confirm", "Dette nulstiller den ugentlige magnetitfragment-tæller til 0."},
            {"gaeting_reset_confirm", "Dette nulstiller den ugentlige Gaeting-krystal-tæller til 0."},
            {"dismiss_api_warning", "Afvis API-advarsel"},
            {"no_api_discrepancy", "Ingen API-uoverensstemmelse (sidste kontrol stemmer overens med DRF)."},
            {"api_discrepancy_message", "Wallet API fik %d fragment(er) mere end DRF tællede. Dette er NORMALT, når du modtager CM'er, kister, mini-salg, præstationer eller salvage. Hvis du VED, at rigtige mødefragmenter blev glemt, skal du manuelt redigere den ugentlige tæller ovenfor."},
            {"api_discrepancy_message_gaeting", "Wallet API fik %d krystal(er) mere end DRF tællede. Dette er NORMALT, når du modtager kister, mini-salg, præstationer eller salvage. Hvis du VED, at rigtige mødekrystaller blev glemt, skal du manuelt redigere den ugentlige tæller ovenfor."},
            {"output", "Output"},
            {"folder", "Mappe"},
            {"max_size_mb", "Maks. størrelse (MB)"},
            {"delete_after_days", "Slet efter (dage)"},
            {"current_export_path", "Nuværende eksportsti"},
            {"drf", "DRF"},
            {"gw2_api", "GW2 API"},
            {"ignored_items", "Ignorerede genstande"},
            {"favorites", "Favoritter"},
            {"first_5_custom_profit", "Første 5 tilpassede overskud"},
            {"api_key", "API-nøgle"},
            {"set", "Indstillet"},
            ...
            {"s", "S"},
            {"c", "K"},
            {"warning_missed_shards", "ADVARSEL: Mulige glemte ugentlige fragmenter detekteret."},
            {"warning_missed_shards_message", "Wallet API rapportærede %d flere fragmenter vundet end DRF tællede. Dette er NORMALT, når du modtager CM'er, kister, mini-salg, præstationer eller salvage. Hvis du er SIKKER på, at rigtige mødefragmenter blev glemt, skal du manuelt redigere den ugentlige tæller ovenfor."},
            {"warning_missed_crystals", "ADVARSEL: Mulige glemte ugentlige krystaller detekteret."},
            {"warning_missed_crystals_message", "Wallet API rapportærede %d flere krystaller vundet end DRF tællede. Dette er NORMALT, når du modtager kister, mini-salg, præstationer eller salvage. Hvis du er SIKKER på, at rigtige mødekrystaller blev glemt, skal du manuelt redigere den ugentlige tæller ovenfor."},
        };
        return translations;
    }
}