...
namespace Localization
{
    const std::unordered_map<std::string, const char*> GetFinnishTranslations()
    {
        static const std::unordered_map<std::string, const char*> translations = {
            ...
            {"icon_cache_unlimited", "Rajoittamaton (∞)"},
            {"icon_cache_unlimited_tooltip", "Ei rajoitusta kuvake-välimuistin koolle"},
            ...
            {"mini_window_click_through", "Ikkuna click through (no longer movable or resizable)"},
            ...
            {"mini_window_locked", "Lukitse Mini Ikkuna (no longer movable or resizable)"},
            ...
            {"api_discrepancy_active", "API-epäjohdonnaisuus aktiivinen"},
            {"magnetite_reset_confirm", "Tämä nollaa viikoittaisen magnetiittisirpalen laskurin 0:aan."},
            {"gaeting_reset_confirm", "Tämä nollaa viikoittaisen Gaeting-kristallin laskurin 0:aan."},
            {"dismiss_api_warning", "Hylkää API-varoitus"},
            {"no_api_discrepancy", "Ei API-epäjohdonnaisuutta (viimeinen tarkistus vastaa DRF:ää)."},
            {"api_discrepancy_message", "Lompakko API sai %d sirpalea(a) enemmän kuin DRF laski. Tämä on NORMAALIA, kun saatte CM:itä, arkkuja, mini-myyntejä, saavutuksia tai pelastusta. Jos TIEDÄT, että oikeita kohtaamissirpaleita unohdettiin, muokkaa manuaalisesti viikoittaista laskuria yllä."},
            {"api_discrepancy_message_gaeting", "Lompakko API sai %d kristallia enemmän kuin DRF laski. Tämä on NORMAALIA, kun saatte arkkuja, mini-myyntejä, saavutuksia tai pelastusta. Jos TIEDÄT, että oikeita kohtaamiskristalleja unohdettiin, muokkaa manuaalisesti viikoittaista laskuria yllä."},
            {"output", "Lähtö"},
            {"folder", "Kansio"},
            {"max_size_mb", "Max koko (MB)"},
            {"delete_after_days", "Poista jälkeen (päivät)"},
            {"current_export_path", "Nykyinen vientipolku"},
            {"drf", "DRF"},
            {"gw2_api", "GW2 API"},
            {"ignored_items", "Sivuutetut esineet"},
            {"favorites", "Suosikit"},
            {"first_5_custom_profit", "Ensimmäiset 5 mukautettua voittoa"},
            {"api_key", "API-avain"},
            {"set", "Asetettu"},
            {"not_set", "Ei asetettu"},
            {"drf_token", "DRF-token"},
            {"next_reset", "Seuraava nollaus"},
            {"g", "K"},
            {"s", "H"},
            {"c", "K"},
            {"warning_missed_shards", "VAROITUS: Mahdolliset unohdetut viikoittaiset sirpaleet havaittu."},
            {"warning_missed_shards_message", "Lompakko API raportoi %d enemmän sirpaleita voitettuna kuin DRF laski. Tämä on NORMAALIA, kun saatte CM:itä, arkkuja, mini-myyntejä, saavutuksia tai pelastusta. Jos olet VARMA, että oikeita kohtaamissirpaleita unohdettiin, muokkaa manuaalisesti viikoittaista laskuria yllä."},
            {"warning_missed_crystals", "VAROITUS: Mahdolliset unohdetut viikoittaiset kristallit havaittu."},
            {"warning_missed_crystals_message", "Lompakko API raportoi %d enemmän kristalleja voitettuna kuin DRF laski. Tämä on NORMAALIA, kun saatte arkkuja, mini-myyntejä, saavutuksia tai pelastusta. Jos olet VARMA, että oikeita kohtaamiskristalleja unohdettiin, muokkaa manuaalisesti viikoittaista laskuria yllä."},
        };
        return translations;
    }
}