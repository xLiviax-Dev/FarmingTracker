...
namespace Localization
{
    const std::unordered_map<std::string, const char*> GetEnglishTranslations()
    {
        static const std::unordered_map<std::string, const char*> translations = {
            ...
            {"custom_profit_feature_placeholder", "Feature implemented - UI to be added"},
            ...
            {"filter_favorite_tooltip", "Show favorite items"},
            {"filter_not_favorite", "Not Favorite"},
            {"filter_not_favorite_tooltip", "Show non-favorite items"},
            ...
            {"show_ignored_items_tooltip", "Show ignored items/currencies in Items and Currencies tabs (uncheck to hide them)"},
