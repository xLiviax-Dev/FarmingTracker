...
namespace Localization
{
    const std::unordered_map<std::string, const char*> GetEnglishTranslations()
    {
        static const std::unordered_map<std::string, const char*> translations = {
            ...
            {"show_bank_count", "Show Bank Count"},
                {"show_bank_count_tooltip", "When enabled, shows the count from your regular account bank next to pinned items in the Mini Window"},
            ...
            {"icon_cache_unlimited", "Unlimited (∞)"},
            {"icon_cache_unlimited_tooltip", "No limit for icon cache size"},
            ...
            {"mini_window_click_through", "Mini Window click through (no longer movable or resizable)"},
            ...
            {"mini_window_locked", "Lock Mini Window (no longer movable or resizable)"},
            ...
            {"api_discrepancy_active", "API discrepancy active"},
            {"magnetite_reset_confirm", "This will reset the weekly Magnetite Shard counter to 0."},
            {"gaeting_reset_confirm", "This will reset the weekly Gaeting Crystal counter to 0."},
            {"dismiss_api_warning", "Dismiss API warning"},
            {"no_api_discrepancy", "No API discrepancy (last check agrees with DRF)."},
            {"api_discrepancy_message", "Wallet gained %d shard(s) more than DRF counted. This is NORMAL when you receive CMs, chests, mini sales, achievements, or salvage. If you KNOW some real encounter shards were missed, manually edit the weekly-earned counter above."},
            {"api_discrepancy_message_gaeting", "Wallet gained %d crystal(s) more than DRF counted. This is NORMAL when you receive chests, mini sales, achievements, or salvage. If you KNOW some real encounter crystals were missed, manually edit the weekly-earned counter above."},
            ...
            {"delete_after_days", "Delete after (days)"},
            {"current_export_path", "Current Export Path"},
            {"drf", "DRF"},
            {"gw2_api", "GW2 API"},
            {"ignored_items", "Ignored Items"},
            {"favorites", "Favorites"},
            {"first_5_custom_profit", "First 5 Custom Profit"},
            {"api_key", "API Key"},
            {"set", "Set"},
            {"not_set", "Not Set"},
            {"drf_token", "DRF Token"},
            ...
            {"s", "S"},
            {"c", "C"},
            {"warning_missed_shards", "WARNING: Possible missed weekly shards detected."},
            {"warning_missed_shards_message", "The wallet API reported %d more shards gained than DRF counted. This is NORMAL when you receive CMs, chests, mini sales, achievements, or salvage. If you KNOW some real encounter shards were missed, manually edit the weekly-earned counter above."},
            {"warning_missed_crystals", "WARNING: Possible missed weekly crystals detected."},
            {"warning_missed_crystals_message", "The wallet API reported %d more crystals gained than DRF counted. This is NORMAL when you receive chests, mini sales, achievements, or salvage. If you KNOW some real encounter crystals were missed, manually edit the weekly-earned counter above."},
        };
        return translations;
    }
}