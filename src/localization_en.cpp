...
namespace Localization
{
    const std::unordered_map<std::string, const char*> GetEnglishTranslations()
    {
        static const std::unordered_map<std::string, const char*> translations = {
            ...
            {"show_item_icons", "Show Item Icons"},
            {"show_item_icons_tooltip", "Display item icons in the list"},
            {"history_icon_size", "History Icon Size"},
            {"history_icon_size_tooltip", "Size of item icons in Session History (16-96)"},
            {"profit_icon_size", "Profit Icon Size"},
            {"profit_icon_size_tooltip", "Size of item icons in Profit Tab (16-96)"},
            {"items_icon_size", "Items Icon Size"},
            {"items_icon_size_tooltip", "Size of item icons in Items/Currencies/Favorites/Ignored tabs (16-96)"},
            {"icon_size", "Icon Size"},
            ...
            {"grid_icon_size_items_tooltip", "Size of icons in grid view for Items (16-96)"},
            ...
            {"grid_icon_size_currencies_tooltip", "Size of icons in grid view for Currencies (16-96)"},
            ...
            {"mini_window_enable_text_shadow", "Bold Text"},
            {"mini_window_enable_text_shadow_tooltip", "Make text bold with black outline for better visibility at high transparency"},
