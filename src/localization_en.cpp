...
namespace Localization
{
    const std::unordered_map<std::string, const char*> GetEnglishTranslations()
    {
        static const std::unordered_map<std::string, const char*> translations = {
            ...
            {"save_all_items_in_history", "Save All Items"},
            {"save_all_items_in_history_tooltip", "Save all dropped items (increases file size)"},
            {"save_all_items_confirm", "Save all items in history?"},
