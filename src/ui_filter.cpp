...
void RenderFilterTab()
{
    ...
    if (ImGui::Checkbox(Localization::GetText("filter_tyrian_defense_seal"), &g_Settings.filterTyrianDefenseSeal))
        SettingsManager::Save();
    if (ImGui::IsItemHovered())
        ImGui::SetTooltip("%s", Localization::GetText("filter_tyrian_defense_seal_tooltip"));
    ImGui::SameLine();
    ...
    ImGui::SameLine();
    if (ImGui::Checkbox(Localization::GetText("filter_canach_coins"), &g_Settings.filterCanachCoins))
        SettingsManager::Save();
    if (ImGui::IsItemHovered())
        ImGui::SetTooltip("%s", Localization::GetText("filter_canach_coins_tooltip"));
    if (ImGui::Checkbox(Localization::GetText("filter_ancient_coin"), &g_Settings.filterAncientCoin))
        SettingsManager::Save();
    if (ImGui::IsItemHovered())
        ImGui::SetTooltip("%s", Localization::GetText("filter_ancient_coin_tooltip"));
    ImGui::SameLine();
    if (ImGui::Checkbox(Localization::GetText("filter_unusual_coin"), &g_Settings.filterUnusualCoin))
        SettingsManager::Save();
    if (ImGui::IsItemHovered())
        ImGui::SetTooltip("%s", Localization::GetText("filter_unusual_coin_tooltip"));
    ...
    if (g_Settings.showRangeFilters)
    {
        ...
        if (ImGui::InputInt(Localization::GetText("filter_min_price"), &g_Settings.filterMinPrice))
            SettingsManager::Save();
        if (ImGui::IsItemHovered())
            ImGui::SetTooltip("%s", Localization::GetText("filter_min_price_tooltip"));
        ImGui::SameLine();
        if (ImGui::InputInt(Localization::GetText("filter_max_price"), &g_Settings.filterMaxPrice))
            SettingsManager::Save();
        if (ImGui::IsItemHovered())
