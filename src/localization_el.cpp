...
namespace Localization
{
    const std::unordered_map<std::string, const char*> GetGreekTranslations()
    {
        static const std::unordered_map<std::string, const char*> translations = {
            ...
            {"count_label", "Count:"},
            {"profit_label", "Profit:"},
            {"total_drops_label", "Total Drops:"},
            {"average_per_session_label", "Average per Session:"},
            ...
            {"icon_cache_unlimited", "Απεριόριστο (∞)"},
            {"icon_cache_unlimited_tooltip", "Χωρίς όριο για το μέγεθος της cache εικονιδίων"},
            ...
            {"mini_window_click_through", "Παράθυρο click through (no longer movable or resizable)"},
            {"mini_window_click_through_tooltip", "Allows clicking through the mini window to the game (no longer movable or resizable)"},
            ...
            {"mini_window_locked", "Κλείδωμα Mini Παράθυρο (no longer movable or resizable)"},
            ...
            {"api_discrepancy_active", "Ενεργή ασυμφωνία API"},
            {"magnetite_reset_confirm", "Αυτό θα επαναφέρει τον εβδομαδιαίο μετρητή θραυσμάτων μαγνητίτη στο 0."},
            {"gaeting_reset_confirm", "Αυτό θα επαναφέρει τον εβδομαδιαίο μετρητή κρυστάλλων Gaeting στο 0."},
            {"dismiss_api_warning", "Αγνόηση προειδοποίησης API"},
            {"no_api_discrepancy", "Καμία ασυμφωνία API (η τελευταία έλεγχος συμφωνεί με DRF)."},
            {"api_discrepancy_message", "Το πορτοφόλι API κέρδισε %d θραύσμα(α) περισσότερα από όσα μέτρησε το DRF. Αυτό είναι ΚΑΝΟΝΙΚΟ όταν λαμβάνετε CM, σεντούκια, πωλήσεις mini, επιτεύγματα ή salvage. Αν ΓΝΩΡΙΖΕΤΕ ότι πραγματικά θραύσματα συναντήσεων χάθηκαν, επεξεργαστείτε χειροκίνητα τον εβδομαδιαίο μετρητή παραπάνω."},
            {"api_discrepancy_message_gaeting", "Το πορτοφόλι API κέρδισε %d κρύσταλλο(ους) περισσότερα από όσα μέτρησε το DRF. Αυτό είναι ΚΑΝΟΝΙΚΟ όταν λαμβάνετε σεντούκια, πωλήσεις mini, επιτεύγματα ή salvage. Αν ΓΝΩΡΙΖΕΤΕ ότι πραγματικά κρύσταλλοι συναντήσεων χάθηκαν, επεξεργαστείτε χειροκίνητα τον εβδομαδιαίο μετρητή παραπάνω."},
            {"output", "Έξοδος"},
            {"folder", "Φάκελος"},
            {"max_size_mb", "Μέγ. μέγεθος (MB)"},
            {"delete_after_days", "Διαγραφή μετά (μέρες)"},
            {"current_export_path", "Τρέχουσα διαδρομή εξαγωγής"},
            {"drf", "DRF"},
            {"gw2_api", "GW2 API"},
            {"ignored_items", "Αγνοημένα αντικείμενα"},
            {"favorites", "Αγαπημένα"},
            {"first_5_custom_profit", "Πρώτα 5 προσαρμοσμένα κέρδη"},
            {"api_key", "Κλειδί API"},
            {"set", "Ορισμένο"},
            {"not_set", "Μη ορισμένο"},
            {"drf_token", "Token DRF"},
            {"next_reset", "Επόμενη επαναφορά"},
            {"g", "Χ"},
            {"s", "Α"},
            {"c", "Χ"},
            {"warning_missed_shards", "ΠΡΟΕΙΔΟΠΟΙΗΣΗ: Εντοπίστηκαν πιθανά χαμένα εβδομαδιαία θραύσματα."},
            {"warning_missed_shards_message", "Το API πορτοφολίου ανέφερε %d περισσότερα θραύσματα κερδισμένα από όσα μέτρησε το DRF. Αυτό είναι ΚΑΝΟΝΙΚΟ όταν λαμβάνετε CM, σεντούκια, πωλήσεις mini, επιτεύγματα ή salvage. Αν είστε ΣΙΓΟΥΡΟΣ ότι πραγματικά θραύσματα συναντήσεων χάθηκαν, επεξεργαστείτε χειροκίνητα τον εβδομαδιαίο μετρητή παραπάνω."},
            {"warning_missed_crystals", "ΠΡΟΕΙΔΟΠΟΙΗΣΗ: Εντοπίστηκαν πιθανά χαμένα εβδομαδιαία κρύσταλλα."},
            {"warning_missed_crystals_message", "Το API πορτοφολίου ανέφερε %d περισσότερα κρύσταλλα κερδισμένα από όσα μέτρησε το DRF. Αυτό είναι ΚΑΝΟΝΙΚΟ όταν λαμβάνετε σεντούκια, πωλήσεις mini, επιτεύγματα ή salvage. Αν είστε ΣΙΓΟΥΡΟΣ ότι πραγματικά κρύσταλλοι συναντήσεων χάθηκαν, επεξεργαστείτε χειροκίνητα τον εβδομαδιαίο μετρητή παραπάνω."},
        };
        return translations;
    }
}