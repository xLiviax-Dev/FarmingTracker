...
namespace Localization
{
    const std::unordered_map<std::string, const char*> GetRomanianTranslations()
    {
        static const std::unordered_map<std::string, const char*> translations = {
            ...
            {"timeline_liquid_coins", "Aur Lichid"},
            ...
            {"token_invalid_utf8", "(UTF-8 invalid)"},
            ...
            {"average_per_session_label", "Medie per Sesiune:"},
            {"above_average_label", "Peste Medie:"},
            {"below_average_label", "Sub Medie:"},
            ...
            {"rarity_tooltip", "Filtrează obiecte după raritate minimă"},
            ...
            {"coins_tooltip", "Aur total colectat în această sesiune"},
            {"timeline_profit_hour_listings_tooltip", "Profituri de tranzacționare pe oră prin listări (15% taxă dedusă)"},
            {"timeline_profit_hour_instant_tooltip", "Profituri de tranzacționare pe oră prin vânzare instantanee (15% taxă dedusă)"},
            ...
            {"icon_cache_unlimited", "Nelimitat (∞)"},
            {"icon_cache_unlimited_tooltip", "Fără limită pentru dimensiunea cache-ului de pictograme"},
            ...
            {"mini_window_click_through", "Fereastră click through (no longer movable or resizable)"},
            ...
            {"mini_window_locked", "Blocare Mini Fereastră (no longer movable or resizable)"},
            ...
            {"api_discrepancy_active", "Discrepanță API activă"},
            {"magnetite_reset_confirm", "Acest lucru va reseta contorul săptămânal de fragmente de magnetită la 0."},
            {"gaeting_reset_confirm", "Acest lucru va reseta contorul săptămânal de cristale Gaeting la 0."},
            {"dismiss_api_warning", "Ignoră avertisment API"},
            {"no_api_discrepancy", "Fără discrepanță API (ultima verificare corespunde cu DRF)."},
            {"api_discrepancy_message", "Portofelul API a câștigat %d fragment(e) mai mult decât a numărat DRF. Acest lucru este NORMAL când primiți CM-uri, cufere, vânzări mini, realizări sau salvare. Dacă ȘTIȚI că fragmente reale de întâlnire au fost ratate, editați manual contorul săptămânal de mai sus."},
            {"api_discrepancy_message_gaeting", "Portofelul API a câștigat %d cristal(e) mai mult decât a numărat DRF. Acest lucru este NORMAL când primiți cufere, vânzări mini, realizări sau salvare. Dacă ȘTIȚI că cristale reale de întâlnire au fost ratate, editați manual contorul săptămânal de mai sus."},
            {"output", "Ieșire"},
            {"folder", "Folder"},
            {"max_size_mb", "Dim. max (MB)"},
            {"delete_after_days", "Șterge după (zile)"},
            {"current_export_path", "Calea de export curentă"},
            {"drf", "DRF"},
            {"gw2_api", "API GW2"},
            {"ignored_items", "Elemente ignorate"},
            {"favorites", "Favorite"},
            {"first_5_custom_profit", "Primele 5 profituri personalizate"},
            {"api_key", "Cheie API"},
            {"set", "Setat"},
            {"not_set", "Nesetat"},
            {"drf_token", "Token DRF"},
            ...
            {"s", "A"},
            {"c", "C"},
            {"warning_missed_shards", "AVERTISMENT: Posibile fragmente săptămânale ratate detectate."},
            {"warning_missed_shards_message", "API-ul portofelului a raportat %d fragmente mai câștigate decât a numărat DRF. Acest lucru este NORMAL când primiți CM-uri, cufere, vânzări mini, realizări sau salvare. Dacă sunteți SIGUR că fragmente reale de întâlnire au fost ratate, editați manual contorul săptămânal de mai sus."},
            {"warning_missed_crystals", "AVERTISMENT: Posibile cristale săptămânale ratate detectate."},
            {"warning_missed_crystals_message", "API-ul portofelului a raportat %d cristale mai câștigate decât a numărat DRF. Acest lucru este NORMAL când primiți cufere, vânzări mini, realizări sau salvare. Dacă sunteți SIGUR că cristale reale de întâlnire au fost ratate, editați manual contorul săptămânal de mai sus."},
        };
        return translations;
    }
}