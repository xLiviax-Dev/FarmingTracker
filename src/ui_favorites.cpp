                           ...
                           const char* totalLabel)
{
    ...
    ImGui::BeginChild("##fav_stats",{avail,kH},false,ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse);
...
static bool RenderCurrenciesSubTab()
{
    ...
    // Stats bar (currencies have no rarity, just a total)
    {
        ...
        ImGui::PushStyleColor(ImGuiCol_ChildBg,ImVec4(0,0,0,0));
        ImGui::BeginChild("##favcur_stats",{avail,kH},false,ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse);
        ImGui::SetCursorPosY(ImGui::GetCursorPosY()+std::max(0.f,(kH-ImGui::GetTextLineHeight())*.5f));
        ImGui::SetCursorPosX(10.f);
