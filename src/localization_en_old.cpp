...
namespace Localization
{
    const std::unordered_map<std::string, const char*> GetEnglishTranslations()
    {
        static const std::unordered_map<std::string, const char*> translations = {
            ...
            {"timeline_icon_size_items", "Timeline Icon Size (Items)"},
            {"timeline_icon_size_items_tooltip", "Size of item icons in Timeline tab (16-96)"},
            {"timeline_icon_size_currencies", "Timeline Icon Size (Currencies)"},
            {"timeline_icon_size_currencies_tooltip", "Size of currency icons in Timeline tab (16-48)"},
            ...
            {"total_profit_label", "Total Profit:"},
            {"tp_sell_profit_label", "TP Sell Profit:"},
            {"tp_sell_profit_tooltip", "Total profit if all items sold at current TP listing prices (minus 15% fee)"},
            ...
            {"map", "Map"},
            {"clear_history", "Clear History"},
            {"clear_history_tooltip", "Clear all saved session history"},
            {"clear_history_confirm", "Clear all session history?"},
            {"clear_history_warning", "This action cannot be undone!"},
            {"yes_clear", "Yes, Clear"},
            {"no_cancel", "No, Cancel"},
            ...
            {"tab_session_history", "Session History"},
            {"save_current_session", "Save Current Session"},
            {"save_current_session_tooltip", "Save the current farming session without reset"},
            {"rarity_all", "Rarity: all"},
            {"rarity_basic", "Rarity: Basic+"},
            {"rarity_fine", "Rarity: Fine+"},
            {"rarity_masterwork", "Rarity: Masterwork+"},
            ...
            {"favorites_first_tooltip", "Shows favorites first in item/currency lists"},
            {"enable_favorite_text_color", "Enable favorite text color"},
            {"enable_favorite_text_color_tooltip", "Highlight favorite items/currencies with custom text color"},
            {"text_color", "Text Color"},
            {"enable_favorite_row_color", "Enable favorite row color"},
            {"enable_favorite_row_color_tooltip", "Highlight favorite items/currencies with custom row background color"},
            {"row_color", "Row Color"},
            ...
            {"bottom_gradient_color_tooltip", "Bottom gradient color"},
            {"show_item_icons", "Show item icons (GW2 render)"},
            {"show_item_icons_tooltip", "Load icons from render.guildwars2.com via Nexus"},
            {"icon_size", "Icon Size"},
            {"icon_size_tooltip", "Size of item icons in pixels (16-96)"},
            {"rarity_border_thickness", "Rarity Border Thickness"},
            {"rarity_border_thickness_tooltip", "Adjust the thickness of rarity borders (1.0 - 10.0)"},
            ...
            {"mini_window_hide_title_bar", "Hide Mini Window Title Bar"},
            {"mini_window_hide_title_bar_tooltip", "Hide the title bar of the mini window"},
            {"mini_window_locked", "Mini Window Locked"},
            {"mini_window_locked_tooltip", "Fix the mini window position and size (no longer movable or resizable)"},
            {"main_window_click_through", "Main Window click through"},
            {"main_window_click_through_tooltip", "Allows clicking through the main window to the game"},
            {"settings_profiles", "Settings Profiles"},
            ...
            {"display_settings", "Display Settings"},
            {"show_item_icons", "Show item icons"},
            {"show_item_icons_tooltip", "Show item icons in list"},
            {"show_rarity_borders", "Show rarity borders"},
            ...
            {"custom_profit_import_tooltip",  "Import custom profit from file"},
            ...
            {"open_folder_tooltip",           "Open folder in file explorer"},
