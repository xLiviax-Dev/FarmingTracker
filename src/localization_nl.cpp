...
namespace Localization
{
    const std::unordered_map<std::string, const char*> GetDutchTranslations()
    {
        static const std::unordered_map<std::string, const char*> translations = {
            ...
            {"timeline_liquid_coins", "Vloeibaar Goud"},
            ...
            {"token_invalid_utf8", "(Ongeldige UTF-8)"},
            ...
            {"count_label", "Aantal:"},
            {"profit_label", "Winst:"},
            {"total_drops_label", "Totaal Drops:"},
            {"average_per_session_label", "Gemiddeld per Sessie:"},
            {"above_average_label", "Boven Gemiddeld:"},
            {"below_average_label", "Onder Gemiddeld:"},
            ...
            {"coins_tooltip", "Totaal goud verzameld deze sessie"},
            {"timeline_profit_hour_listings_tooltip", "Handelswinsten per uur via lijsten (15% fee afgetrokken)"},
            {"timeline_profit_hour_instant_tooltip", "Handelswinsten per uur via directe verkoop (15% fee afgetrokken)"},
            ...
            {"icon_cache_unlimited", "Onbeperkt (∞)"},
            {"icon_cache_unlimited_tooltip", "Geen limiet voor de grootte van de icoon-cache"},
            ...
            {"mini_window_click_through", "Venster click through (no longer movable or resizable)"},
            ...
            {"mini_window_locked", "Vergrendelen Mini Venster (no longer movable or resizable)"},
            ...
            {"api_discrepancy_active", "API-discrepantie actief"},
            {"magnetite_reset_confirm", "Dit reset de wekelijkse magnetietfragmentteller naar 0."},
            {"gaeting_reset_confirm", "Dit reset de wekelijkse Gaeting-kristalteller naar 0."},
            {"dismiss_api_warning", "API-waarschuwing negeren"},
            {"no_api_discrepancy", "Geen API-discrepantie (laatste controle komt overeen met DRF)."},
            {"api_discrepancy_message", "De portemonnee API kreeg %d fragment(en) meer dan DRF telde. Dit is NORMAAL als je CM's, kisten, mini-verkopen, prestaties_of salvaging ontvangt. Als je WEET dat echte ontmoetingsfragmenten werden gemist, bewerk dan handmatig de wekelijkse teller hierboven."},
            {"api_discrepancy_message_gaeting", "De portemonnee API kreeg %d kristal(len) meer dan DRF telde. Dit is NORMAAL als je kisten, mini-verkopen, prestaties of salvaging ontvangt. Als je WEET dat echte ontmoetingskristallen werden gemist, bewerk dan handmatig de wekelijkse teller hierboven."},
            {"output", "Uitvoer"},
            {"folder", "Map"},
            {"max_size_mb", "Max. grootte (MB)"},
            {"delete_after_days", "Verwijderen na (dagen)"},
            {"current_export_path", "Huidig exportpad"},
            {"drf", "DRF"},
            {"gw2_api", "GW2 API"},
            {"ignored_items", "Genegeerde items"},
            {"favorites", "Favorieten"},
            {"first_5_custom_profit", "Eerste 5 aangepaste winsten"},
            {"api_key", "API-sleutel"},
            {"set", "Ingesteld"},
            {"not_set", "Niet ingesteld"},
            {"drf_token", "DRF-token"},
            ...
            {"s", "Z"},
            {"c", "K"},
            {"warning_missed_shards", "WAARSCHUWING: Mogelijke gemiste wekelijkse fragmenten gedetecteerd."},
            {"warning_missed_shards_message", "De portemonnee API rapporteerde %d meer fragmenten gewonnen dan DRF telde. Dit is NORMAAL als je CM's, kisten, mini-verkopen, prestaties of salvaging ontvangt. Als je ZEKER bent dat echte ontmoetingsfragmenten werden gemist, bewerk dan handmatig de wekelijkse teller hierboven."},
            {"warning_missed_crystals", "WAARSCHUWING: Mogelijke gemiste wekelijkse kristallen gedetecteerd."},
            {"warning_missed_crystals_message", "De portemonnee API rapporteerde %d meer kristallen gewonnen dan DRF telde. Dit is NORMAAL als je kisten, mini-verkopen, prestaties of salvaging ontvangt. Als je ZEKER bent dat echte ontmoetingskristallen werden gemist, bewerk dan handmatig de wekelijkse teller hierboven."},
        };
        return translations;
    }
}