...
namespace Localization
{
    const std::unordered_map<std::string, const char*> GetHungarianTranslations()
    {
        static const std::unordered_map<std::string, const char*> translations = {
            ...
            {"timeline_liquid_coins", "Folyékony Arany"},
            ...
            {"best_drop_single", "Legjobb Drop (Egységérték)"},
            {"best_drop_total", "Legjobb Drop (Teljes érték)"},
            {"unit_value", "Egységérték"},
            {"total_value", "Teljes érték"},
            {"mini_window_show_best_drop_single", "Legjobb Drop megjelenítése (Egységérték)"},
            {"mini_window_show_best_drop_total", "Legjobb Drop megjelenítése (Teljes érték)"},
            {"top_items_profit", "Top tárgyak (Profit)"},
            {"top_items_profit_tooltip", "Top 5 tárgy profit érték szerint"},
            {"loading", "Betöltés..."},
            {"coin", "Érme"},
            {"coins", "Érmék"},
            {"no_currencies", "Nincs valuta"},
            {"dash", "-"},
            {"ellipsis", "..."},
            {"pipe", "|"},
            ...
            {"count_label", "Darab:"},
            {"profit_label", "Profit:"},
            {"total_drops_label", "Összes Drop:"},
            {"average_per_session_label", "Átlag Munkamenetenként:"},
            {"above_average_label", "Átlag Felett:"},
            {"below_average_label", "Átlag Alatt:"},
            ...
            {"coins_tooltip", "Teljes arany összegyűjtve ebben a munkamenetben"},
            {"timeline_profit_hour_listings_tooltip", "Kereskedési profitok óránként listázásokon keresztül (15% díj levonva)"},
            {"timeline_profit_hour_instant_tooltip", "Kereskedési profitok óránként azonnali eladáson keresztül (15% díj levonva)"},
            ...
            {"icon_cache_unlimited", "Korlátlan (∞)"},
            {"icon_cache_unlimited_tooltip", "Nincs korlát az ikon-gyorsítótár méretére"},
            ...
            {"mini_window_click_through", "Ablak click through (no longer movable or resizable)"},
            ...
            {"mini_window_locked", "Zárolás Mini Ablak (no longer movable or resizable)"},
            ...
            {"api_discrepancy_active", "API eltérés aktív"},
            {"magnetite_reset_confirm", "Ez visszaállítja a heti magnetit töredékszámlálót 0-ra."},
            {"gaeting_reset_confirm", "Ez visszaállítja a heti Gaeting kristályszámlálót 0-ra."},
            {"dismiss_api_warning", "API figyelmeztetés elutasítása"},
            {"no_api_discrepancy", "Nincs API eltérés (utolsó ellenőrzés egyezik a DRF-fel)."},
            {"api_discrepancy_message", "A pénztárca API %d töredéket kapott többet, mint a DRF számolt. Ez NORMÁLIS, ha CM-ket, ládákat, mini eladásokat, teljesítményeket vagy salvage-t kapsz. Ha TUDOD, hogy valódi találkozó töredékek hiányoztak, szerkeszd manuálisan a heti számlálót fent."},
            {"api_discrepancy_message_gaeting", "A pénztárca API %d kristályt kapott többet, mint a DRF számolt. Ez NORMÁLIS, ha ládákat, mini eladásokat, teljesítményeket vagy salvage-t kapsz. Ha TUDOD, hogy valódi találkozó kristályok hiányoztak, szerkeszd manuálisan a heti számlálót fent."},
            {"output", "Kimenet"},
            {"folder", "Mappa"},
            {"max_size_mb", "Max méret (MB)"},
            {"delete_after_days", "Törlés után (napok)"},
            {"current_export_path", "Jelenlegi export útvonal"},
            {"drf", "DRF"},
            {"gw2_api", "GW2 API"},
            {"ignored_items", "Figyelmen kívül hagyott elemek"},
            {"favorites", "Kedvencek"},
            {"first_5_custom_profit", "Első 5 egyedi profit"},
            {"api_key", "API kulcs"},
            {"set", "Beállítva"},
            {"not_set", "Nincs beállítva"},
            {"drf_token", "DRF token"},
            ...
            {"s", "E"},
            {"c", "K"},
            {"warning_missed_shards", "FIGYELMEZTETÉS: Lehet, hogy hiányzó heti töredékek észlelve."},
            {"warning_missed_shards_message", "A pénztárca API %d több töredékről számolt be nyereséget, mint a DRF. Ez NORMÁLIS, ha CM-ket, ládákat, mini eladásokat, teljesítményeket vagy salvage-t kapsz. Ha BIZTOS vagy benne, hogy valódi találkozó töredékek hiányoztak, szerkeszd manuálisan a heti számlálót fent."},
            {"warning_missed_crystals", "FIGYELMEZTETÉS: Lehet, hogy hiányzó heti kristályok észlelve."},
            {"warning_missed_crystals_message", "A pénztárca API %d több kristályról számolt be nyereséget, mint a DRF. Ez NORMÁLIS, ha ládákat, mini eladásokat, teljesítményeket vagy salvage-t kapsz. Ha BIZTOS vagy benne, hogy valódi találkozó kristályok hiányoztak, szerkeszd manuálisan a heti számlálót fent."},
        };
        return translations;
    }
}