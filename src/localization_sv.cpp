...
namespace Localization
{
    const std::unordered_map<std::string, const char*> GetSwedishTranslations()
    {
        static const std::unordered_map<std::string, const char*> translations = {
            ...
            {"count_label", "Antal:"},
            {"profit_label", "Vinst:"},
            {"total_drops_label", "Totala Drops:"},
            {"average_per_session_label", "Genomsnitt per Session:"},
            {"above_average_label", "Över Genomsnitt:"},
            {"below_average_label", "Under Genomsnitt:"},
            ...
            {"rarity_tooltip", "Filtrera föremål efter lägsta sällsynthet"},
            ...
            {"icon_cache_unlimited", "Obegränsad (∞)"},
            {"icon_cache_unlimited_tooltip", "Ingen gräns för storleken på ikon-cache"},
            ...
            {"mini_window_click_through", "Fönster click through (no longer movable or resizable)"},
            ...
            {"mini_window_locked", "Lås Mini Fönster (no longer movable or resizable)"},
            ...
            {"api_discrepancy_active", "API-discrepan aktiv"},
            {"magnetite_reset_confirm", "Detta återställer den veckovisa magnetitfragmenträknaren till 0."},
            {"gaeting_reset_confirm", "Detta återställer den veckovisa Gaeting-kristallräknaren till 0."},
            {"dismiss_api_warning", "Avvisa API-varning"},
            {"no_api_discrepancy", "Ingen API-discrepan (senaste kontrollen överensstämmer med DRF)."},
            {"api_discrepancy_message", "Plånboken API fick %d fragment mer än DRF räknade. Detta är NORMALT när du får CM, kistor, mini-försäljningar, prestationer eller återvinning. Om du VET att riktiga mötesfragment missades, redigera manuellt den veckovisa räknaren ovan."},
            {"api_discrepancy_message_gaeting", "Plånboken API fick %d kristall(er) mer än DRF räknade. Detta är NORMALT när du får kistor, mini-försäljningar, prestationer eller återvinning. Om du VET att riktiga möteskristaller missades, redigera manuellt den veckovisa räknaren ovan."},
            {"output", "Utmatning"},
            {"folder", "Mapp"},
            {"max_size_mb", "Max storlek (MB)"},
            {"delete_after_days", "Ta bort efter (dagar)"},
            {"current_export_path", "Aktuell exportsökväg"},
            {"drf", "DRF"},
            {"gw2_api", "GW2 API"},
            {"ignored_items", "Ignorerade föremål"},
            {"favorites", "Favoriter"},
            {"first_5_custom_profit", "Första 5 anpassade vinster"},
            {"api_key", "API-nyckel"},
            {"set", "Inställd"},
            {"not_set", "Ej inställd"},
            {"drf_token", "DRF-token"},
            ...
            {"s", "S"},
            {"c", "K"},
            {"warning_missed_shards", "VARNING: Möjliga missade veckovisa fragment upptäckta."},
            {"warning_missed_shards_message", "Plånboken API rapporterade %d fler fragment vunna än DRF räknade. Detta är NORMALT när du får CM, kistor, mini-försäljningar, prestationer eller återvinning. Om du är SÄKER att riktiga mötesfragment missades, redigera manuellt den veckovisa räknaren ovan."},
            {"warning_missed_crystals", "VARNING: Möjliga missade veckovisa kristaller upptäckta."},
            {"warning_missed_crystals_message", "Plånboken API rapporterade %d fler kristaller vunna än DRF räknade. Detta är NORMALT när du får kistor, mini-försäljningar, prestationer eller återvinning. Om du är SÄKER att riktiga möteskristaller missades, redigera manuellt den veckovisa räknaren ovan."},
        };
        return translations;
    }
}