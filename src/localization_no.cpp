...
namespace Localization
{
    const std::unordered_map<std::string, const char*> GetNorwegianTranslations()
    {
        static const std::unordered_map<std::string, const char*> translations = {
            ...
            {"timeline_liquid_coins", "Flytende Gull"},
            ...
            {"best_drop_single", "Beste Drop (Enhetsverdi)"},
            {"best_drop_total", "Beste Drop (Totalverdi)"},
            {"unit_value", "Enhetsverdi"},
            {"total_value", "Totalverdi"},
            {"mini_window_show_best_drop_single", "Vis Beste Drop (Enhetsverdi)"},
            {"mini_window_show_best_drop_total", "Vis Beste Drop (Totalverdi)"},
            {"top_items_profit", "Topp gjenstander (Fortjeneste)"},
            {"top_items_profit_tooltip", "Topp 5 gjenstander etter fortjenesteverdi"},
            {"loading", "Laster..."},
            {"coin", "Mynt"},
            {"coins", "Mynter"},
            {"no_currencies", "Ingen valutaer"},
            {"dash", "-"},
            {"ellipsis", "..."},
            {"pipe", "|"},
            ...
            {"token_invalid_utf8", "(Ugyldig UTF-8)"},
            ...
            {"total_drops_label", "Totalt Drops:"},
            {"average_per_session_label", "Gjennomsnitt per Økt:"},
            {"above_average_label", "Over Gjennomsnitt:"},
            {"below_average_label", "Under Gjennomsnitt:"},
            ...
            {"backup_now_button", "Backup nå"},
            {"backup_success_title", "Backup fullført"},
            {"backup_success_msg", "En manuell backup har blitt opprettet."},
            {"backup_failed_title", "Backup mislyktes"},
            {"backup_failed_msg", "Kunne ikke opprette backup. Sjekk banen."},
            {"restore_backup_button", "Last inn Backup"},
            {"restore_success_title", "Gjenoppretting fullført"},
            {"restore_success_msg", "Innstillingene har blitt lastet inn fra backup."},
            {"restore_failed_title", "Gjenoppretting mislyktes"},
            {"restore_failed_msg", "Kunne ikke laste inn backup. Filen kan være skadet."},
            {"restore_confirm_title", "Gjenopprett Backup?"},
            {"restore_confirm_msg", "Er du sikker på at du vil laste inn denne backupen? Alle nåværende innstillinger vil bli overskrevet."},
            ...
            {"coins_tooltip", "Totalt gull samlet denne økten"},
            {"timeline_profit_hour_listings_tooltip", "Handelsfortjenester per time via listinger (15% avgift trukket fra)"},
            {"timeline_profit_hour_instant_tooltip", "Handelsfortjenester per time via umiddelbart salg (15% avgift trukket fra)"},
            ...
            {"icon_cache_unlimited", "Ubegrenset (∞)"},
            {"icon_cache_unlimited_tooltip", "Ingen grense for størrelsen på ikon-cache"},
            ...
            {"main_window_font_size", "Main Vindu Font Size"},
            ...
            {"mini_window_click_through", "Vindu click through (no longer movable or resizable)"},
            ...
            {"mini_window_locked", "Lås Mini Vindu (no longer movable or resizable)"},
            ...
            {"select_log_folder", "Velg loggmappe"},
            ...
            {"api_discrepancy_active", "API-ufyllighet aktiv"},
            {"magnetite_reset_confirm", "Dette tilbakestiller den ukentlige magnetittfragmenttelleren til 0."},
            {"gaeting_reset_confirm", "Dette tilbakestiller den ukentlige Gaeting-kristalltelleren til 0."},
            {"dismiss_api_warning", "Avvis API-advarsel"},
            {"no_api_discrepancy", "Ingen API-ufyllighet (siste sjekk samsvarer med DRF)."},
            {"api_discrepancy_message", "Lommebok API fikk %d fragment(er) mer enn DRF telte. Dette er NORMALT når du får CM, kister, mini-salg, prestasjoner eller salvering. Hvis du VET at virkelige møtefragmenter ble savnet, rediger manuelt den ukentlige telleren over."},
            {"api_discrepancy_message_gaeting", "Lommebok API fikk %d krystall(er) mer enn DRF telte. Dette er NORMALT når du får kister, mini-salg, prestasjoner eller salvering. Hvis du VET at virkelige møtekristaller ble savnet, rediger manuelt den ukentlige telleren over."},
            {"output", "Utdata"},
            {"folder", "Mappe"},
            {"max_size_mb", "Maks størrelse (MB)"},
            {"delete_after_days", "Slett etter (dager)"},
            {"current_export_path", "Gjeldende eksportsti"},
            {"drf", "DRF"},
            {"gw2_api", "GW2 API"},
            {"ignored_items", "Ignorerte gjenstander"},
            {"favorites", "Favoritter"},
            {"first_5_custom_profit", "Første 5 tilpassede gevinster"},
            {"api_key", "API-nøkkel"},
            {"set", "Satt"},
            {"not_set", "Ikke satt"},
            {"drf_token", "DRF-token"},
            {"next_reset", "Neste tilbakestilling"},
            {"g", "G"},
            {"s", "S"},
            {"c", "K"},
            {"warning_missed_shards", "ADVARSEL: Mulige savnede ukentlige fragmenter oppdaget."},
            {"warning_missed_shards_message", "Lommebok API rapporterte %d flere fragmenter vunnet enn DRF telte. Dette er NORMALT når du får CM, kister, mini-salg, prestasjoner eller salvering. Hvis du er SIKKER på at virkelige møtefragmenter ble savnet, rediger manuelt den ukentlige telleren over."},
            {"warning_missed_crystals", "ADVARSEL: Mulige savnede ukentlige krystaller oppdaget."},
            {"warning_missed_crystals_message", "Lommebok API rapporterte %d flere krystaller vunnet enn DRF telte. Dette er NORMALT når du får kister, mini-salg, prestasjoner eller salvering. Hvis du er SIKKER på at virkelige møtekristaller ble savnet, rediger manuelt den ukentlige telleren over."},
        };
        return translations;
    }
}